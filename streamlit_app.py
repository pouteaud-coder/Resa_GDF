...
st.markdown("""
    ...
    .stButton button {
        ...
        color: white !important;
        border: 0.2px solid #b2d8d8 !important;
    }
    ...
    .stTabs [data-baseweb="tab"] {
        ...
        padding: 6px 18px;
        color: #1b5e20;
        border: 1px solid #a8cfe8 !important;
        font-size: 0.9rem;
    }
    .stTabs [aria-selected="true"] {
        background-color: #1b5e20 !important;
        color: #1b5e20 !important;
        border: 0.5px solid #a8e6cf !important;
    }
    ...
    /* Boutons dans les colonnes (mode Générateur, etc.) */
    ...
    /* Pills (sélection multiple des jours) */
    ...
    /* Désactiver les bordures rouges intempestives sur les champs invalides */
    ...
    with t1:  # ATELIERS
        ...
        if sub == "Générateur":
            if st.session_state['at_list_gen']:
                st.dataframe(pd.DataFrame(st.session_state['at_list_gen']))
